...
Cada sitio tiene ahora un campo **Notas** (columna `NOTAS`), pensado para
observaciones, incidentes o pendientes. Se edita como un cuadro de texto
más grande dentro del formulario de edición/creación, y en la tabla se
muestra recortado con un tooltip (pasa el mouse sobre la celda para ver el
texto completo).
